...
<body class="bg-brand-bgDark text-slate-100 font-sans antialiased overflow-x-hidden">
  ...
  <header class="sticky top-0 z-50 glass-nav transition-all duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <a href="#" class="flex items-center gap-3.5 group">
        <div class="relative h-11 w-16 sm:h-12 sm:w-20 flex items-center justify-center transition duration-300 group-hover:scale-105 drop-shadow-[0_0_16px_rgba(0,229,255,0.45)]">
          <img src="assets/img/DLuz_Digital_Simbolo_Infinity_SemFundo.png" alt="DLuz Digital Logo Infinity" class="h-full w-auto object-contain" />
        </div>
        <div class="flex flex-col">
          <span class="text-xl font-extrabold tracking-tight text-white group-hover:text-brand-cyan transition font-sans flex items-center gap-1.5">
  ...
  <footer class="py-12 border-t border-white/5 bg-brand-bgDark text-slate-400 text-xs font-body">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
      ...
      <div class="flex items-center gap-3">
        <div class="h-9 w-14 flex items-center justify-center flex-shrink-0 drop-shadow-[0_0_10px_rgba(0,229,255,0.3)]">
          <img src="assets/img/DLuz_Digital_Simbolo_Infinity_SemFundo.png" alt="DLuz Digital Logo" class="h-full w-auto object-contain" />
        </div>
        <div>
